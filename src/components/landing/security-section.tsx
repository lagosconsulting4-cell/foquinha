    ...
    <SectionTracker sectionId="security">
      <section className="bg-white py-16 px-4 sm:px-6 lg:px-8 border-t border-slate-100">
        <div className="mx-auto max-w-5xl text-center">
          ...
          <h2 className="mb-6 text-4xl font-black tracking-tighter text-slate-900 md:text-6xl">Seus dados estão <br /> <span className="text-[#25d366]">100% seguros.</span></h2>
          <p className="mx-auto mb-16 max-w-2xl text-xl font-medium text-slate-500">Utilizamos criptografia de ponta a ponta e os mais altos padrões de segurança. Seu foco é nossa única prioridade.</p>
          ...
          <div className="grid gap-8 md:grid-cols-3">
            {[
              ...
              <div key={i} className="group relative flex flex-col items-center text-center rounded-[2.5rem] bg-white p-10 shadow-[0_20px_40px_-15px_rgba(26,35,30,0.05)] ring-1 ring-slate-100 transition-all hover:scale-[1.02] hover:shadow-[0_40px_80px_-20px_rgba(26,35,30,0.1)]">
